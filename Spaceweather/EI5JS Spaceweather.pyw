...
for line in open('noaa_data.txt') :
    if ":Issued:" in line:
...
def space_weather_frame():
    ...
    la1=Label(swframe, text="NOAA Space Weather data", font=("verdana", 11), bg=("#000000"), fg=("#55ff55"))
    la1.pack(pady=3)
    ...
    var.set(date_time)
    la2=Label(swframe, text= str(date_time), font=("verdana", 9), bg=("#000000"), fg=("white"))
    la2.pack()

    var.set(ki)
    la3=Label(swframe, text="Kp index = " + str(ki), font=("verdana", 9), bg=("#000000"), fg=("white"))
    la3.pack()

    var.set(ai)
    la4=Label(swframe, text="Ap index = " + str(ai), font=("verdana", 9), bg=("#000000"), fg=("white"))
    la4.pack()

    var.set(sfi)
    la5=Label(swframe, text="SFI = " + str(sfi), font=("verdana", 9), bg=("#000000"), fg=("white"))
    la5.pack()

    
    if alerts == 2:
        var.set("text")
        button=Button(swframe, text="  No Solar Storm Alerts ", font=("verdana", 10), bg=("#000000"), fg=("#b0b0b0"), height=("2"), borderwidth="0", command=callback)
        button.pack()


    if alerts != 2:
        var.set("text")
        button=Button(swframe, text="  SOLAR STORM ALERT  ", font=("verdana", 10), bg=("#000000"), fg=("#ff6666"), height=("2"), borderwidth="0", command=callback)
        button.pack()
...
def no_network_frame():
    ...
    la1.pack()
    la2=Label(swframe, text=" NOAA Website unreachable ", font=("verdana", 12), bg=("#000000"), fg=("white"))
    la2.pack()
